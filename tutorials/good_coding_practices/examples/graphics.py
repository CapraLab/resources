...
# Version 2.2
# 		Added support for multiple mouse buttons via the 
#			getMouseWithButtons method - Andy

# Version 2.1
#		Bug fix: Fixed clone bug (dictionary not copied) - Andy
#		Bug fix: Pixel all off by 2 due to bug in GraphWin __init__ - Laura
